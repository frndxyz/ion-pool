...
var spawnPoolWorkers = function(){
    ...
    var createPoolWorker = function(forkId){
        ...
        //process.execArgv.push('--debug=' + (5866 + forkId))
...
var startPaymentProcessor = function(){
    ...
    if (!enabledForAny)
        ...
        //var debug = process.execArgv.indexOf('--debug') !== -1;
        //if (debug) cluster.settings.execArgv.push('--debug=' + 5862);
...
var startAuxPaymentProcessor = function(){
    ...
    if (!enabledForAny)
        ...
        //var debug = process.execArgv.indexOf('--debug') !== -1;
        //if (debug) cluster.settings.execArgv.push('--debug=' + 5861);
...
var startWebsite = function(){
    ...
    //var debug = process.execArgv.indexOf('--debug') !== -1;
    //if (debug) cluster.settings.execArgv.push('--debug=' + 5859);
...
var startProfitSwitch = function(){
    ...
    //var debug = process.execArgv.indexOf('--debug') !== -1;
    //if (debug) cluster.settings.execArgv.push('--debug=' + 5860);
